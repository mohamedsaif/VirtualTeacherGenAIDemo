...
namespace VirtualTeacherGenAIDemo.Server.Services
{
    public class SessionService
    {
        ...
        public async Task DeleteSessionAsync(string sessionId, string userId, MessageRepository messageRepository, DashboardService dashboardService, CancellationToken token)
        {
            //Delete all dashboard items associated with the session
            await dashboardService.DeleteDashboardAsync(sessionId);
