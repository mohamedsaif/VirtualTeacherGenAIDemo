...
namespace VirtualTeacherGenAIDemo.Server.Controllers
{
    ...
    public class SessionController : ControllerBase
    {
        ...
        public SessionController(SessionService sessionService, DashboardService dashboardService, ChatService chatService, MessageRepository messageRepository)
        {
        ...
        [HttpDelete("delete")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<IActionResult> DeleteSession([FromBody] DeleteSessionRequest request,CancellationToken token)
        {
            await _sessionService.DeleteSessionAsync(request.SessionId, request.UserId, _messageRepository, _dashboardService, token);
            return Ok();
        }
